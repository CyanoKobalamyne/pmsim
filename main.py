...
def _main():
    ...
    parser.add_argument('-x', '--multiplier', help="multiplier factor between "
                        "the difference in the maximum size of the read and "
                        "write sets for a transaction", default=10, type=int)
    parser.add_argument('-m', '--memory-size', help="total size of memory",
